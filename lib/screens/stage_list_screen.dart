...
class _StageListScreenState extends ConsumerState<StageListScreen>
  ...
  Set<String> _computeWrongStageIds(List<Stage> challenges) {
    final wrongTexts =
...
class _PathHeader extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final allStages = ref.watch(allStagesProvider);
...
class _StagePathTabState extends ConsumerState<_StagePathTab> {
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.level) {
      case StageLevel.beginner:
        allStages = ref.watch(beginnerStagesProvider);
        break;
      case StageLevel.intermediate:
        allStages = ref.watch(intermediateStagesProvider);
        break;
      default:
        allStages = ref.watch(advancedStagesProvider);
    }
          ...
          Expanded(
            child: RefreshIndicator(
              ...
              onRefresh: () async {
                ...
                ref.invalidate(allStagesProvider);
  ...
  void _showPremiumModal(BuildContext context, Stage challenge) {
    showModalBottomSheet(
      context: context,
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(top: Radius.circular(24)),
...
class _StagePathView extends StatelessWidget {
  ...
  final void Function(BuildContext, Stage?) onStageTap;
